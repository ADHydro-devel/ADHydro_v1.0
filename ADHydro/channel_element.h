...
private:
  ...
  double precipitation;            // Precipitation falling on the channel element in meters of water.  Positive means water added to the element.  Must be
                                   // non-negative.
  double precipitationCumulative;  // Cumulative precipitation that has fallen on the channel element in meters of water since last set to zero.  Gets set to
                                   // zero at initialization and each I/O phase.  Positive means water added to the element.  Must be non-negative.
  double evaporation;              // Evaporation or condensation on the channel element in meters of water.  Positive means water added to the element.
                                   // Negative means water removed from the element.
  double evaporationCumulative;    // Cumulative evaporation or condensation on the channel element in meters of water since last set to zero.  Gets set to
                                   // zero at initialization and each I/O phase.  Positive means water added to the element.  Negative means water removed from
                                   // the element.
